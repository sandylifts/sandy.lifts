...
export const TIPS_HI = [
  ...
  { category: "Special",   tip: "Dal aur sabzi zyada mat pakao",             detail: "Overcooking se 15-20% fiber nasha ho jaati hai. Thoda firm pakao — texture better aur gut bacteria ko bhi zyada milega." },
];
