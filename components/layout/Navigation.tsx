          ...
          >
            ...
            <div
              style={{
                ...
                overflow: 'hidden',
                background:
                  'linear-gradient(135deg, rgba(77,163,255,0.05) 0%, rgba(167,139,250,0.05) 100%)',
            ...
            <span
              style={{
                ...
                fontSize: '1.15rem',
                background:
                  'linear-gradient(135deg, #66E6FF 0%, #4DA3FF 50%, #A78BFA 100%)',
                    ...
                    >
                      <Link
                        ...
                        style={{
                          ...
                          color: isActive
                            ? '#FFF'
                            : 'rgba(170, 179, 197, 0.55)',
                          background: isActive
                            ? 'linear-gradient(90deg, rgba(0, 200, 255, 0.1) 0%, transparent 100%)'
                            : 'transparent',
                          borderLeft: isActive
                            ? '4px solid #00c8ff'
                          ...
                          textShadow: isActive
                            ...
                            : 'none',
                          boxShadow: isActive
                            ? 'inset 20px 0 40px -20px rgba(0,200,255,0.15)'
                            : 'none',
                          transition:
                            'color 0.3s, text-shadow 0.3s, font-size 0.3s, font-weight 0.3s',
                        }}
                      >
                        {link.label}
                      </Link>
              ...
              >
                <div
                  style={{
                    height: '1px',
                    background:
                      'linear-gradient(90deg, transparent, rgba(123,111,255,0.3), transparent)',
                    margin: '1.5rem 0',
                  }}
                />
